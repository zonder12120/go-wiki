...
В Go **нет ключевых слов для модификаторов доступа** для переменных, зато есть ЗАГЛАВНЫЕ БУКВЫ!!!11!! (не уверен, что мне это нравится, но ладно)
...
Заглавные буквы являются аналогом модификатора доступа public, справедливо для всех типов данных. Например, структура Person, описанная выше, тоже является публичной.