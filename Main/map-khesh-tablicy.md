...
0000 0000 0000 0000 0000 0000 0111 (mask) 

--------------------------------------------------------------   

0000 0000 0000 0000 0000 0000 0100 (результат = 4)
```

:::

То есть как понятно из вычислений, удобство состоит в том, что логарифм по основанию 2 позволяет правильно выполнять побитовые операции.