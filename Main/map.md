...
**Эвакуация производится НЕ непрерывно, а последовательно**. При выполнении операций вставки или удаления в мапе производится перенос элементов из одного или двух бакетов за раз. То есть за одну операцию 1-2 бакета, если операций не производится, эвакуация тоже стоит.
