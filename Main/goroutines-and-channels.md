...
Планировщик Go работает по модели GMP.

Хоть я выше, в блоке про рантайм, и говорил о том, что такое G, что такое M и что такое P, но давай снова пройдёмся по определениям, подробнее обсудим их работу и поймём в целом, как работает конкурентная работа в Go.

**G** – это горутина, подробнее обсуждали выше.
...
**Основной элемент** **P** -- это **локальная очередь** горутин (Local Run Queue, LRQ), которая содержит горутины, ожидающие выполнения.
...
В LIFO место всего лишь для одной горутины. ???
