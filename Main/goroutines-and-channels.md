...
**Стоп!** Тут некоторые могут слабо представлять, что из себя представляет рантам, хотя это было бы кстати для изучения работы планировщика, ща быстренько исправим.
