...
Теперь задачи выполняются не только **конкурентно**, но и **параллельно**, выполняя больше работы за единицу времени (в нашем случае 1 сек), чем однопоточный процессор.
