...
Например, потока ОС у нас два, а процессор одноядерный однопоточный. Эти 2 потока будут выполняться одновременно, но не параллельно, а постоянно переключаясь с одного на другой путём переключения контекста.
