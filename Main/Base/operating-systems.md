...
**Процесс** -- это экземпляр исполняемой программы. Когда вы запускаете программу, операционная система создаёт новый процесс для её выполнения. Процесс включает в себя код программы, данные, ресурсы (например, файловые дескрипторы), а также своё собственное пространство памяти.
