...
Различия кроются в названии. К ПЗУ у процессора доступа к записи нет, только к чтению. Запись на ПЗУ производится средствами ОС. А ОЗУ у процессора есть возможность и читать, и писать. Только вот при работе процессора с оперативной памятью, которая в виде плашек стоит у вас в материнской плате, есть некоторые особенности.
