...
Есть два подхода написания кода: императивный и декларативный. При императивном мы пишем КАК мы достигаем результата, а при декларативном мы пишем ЧТО мы хотим в итоге получить. 

Современные языки являются мультипарадигменными, в том числе там уже все потеряли грань между императивным и декларативным подходами, не думаю, что это стоит того, чтобы останавливаться. На собесе спросят, что такое императивный, ты скажешь “подход, который говорит КАК”, а как пример насыпешь кода на любом популярном языке программирования, а если про декларативный спросят, то тут ты скажешь “подход, который говорит ЧТО” и приведёшь пример SQL запроса, вёрстки на HTML, структуры JSON, XML и всего такого.

Чепуха полная, я считаю, люди там сами как будто напридумывали определений ради определений, а код ты и так будешь понимать как писать, не вдаваясь в глубину проблем этих терминологий.

Но есть ещё важные 2 парадигмы ЯП.

### Объектно-ориентированное программирование (ООП)

**Объектно-ориентированное программирование** можно определить как модель программирования, основанную на концепции объектов. Объекты содержат данные в виде атрибутов и код в виде методов. В объектно-ориентированном программировании компьютерные программы разрабатываются с использованием концепции объектов, которые взаимодействуют с реальным миром. Объектно-ориентированные языки программирования разнообразны, но наиболее популярные из них основаны на классах, что означает, что объекты являются экземплярами классов, которые также определяют их типы.

### Процедурное программирование

**Процедурное программирование** можно определить как модель программирования, которая является производной от структурированного программирования, основанного на концепции вызывающей процедуры. Процедуры, также известные как подпрограммы или функции, просто состоят из серии вычислительных шагов, которые необходимо выполнить. Во время выполнения программы любая данная процедура может быть вызвана в любой момент, в том числе другими процедурами или самой собой.

Императивный: Процедурный и ООП (что же у нас в Go?)

Типизация: динамичская/статическая, явная/неявная, сильная/слабая