...
Ранее существовали 16-битные регистры, такие как AX, BX, CX и DX. После расширения до 32 бит, старые 16-битные регистры были включены в новые расширенные регистры. Например, AX является младшими 16 битами регистра EAX. Таким образом, к 16-битному регистру AX можно по-прежнему обратиться, и он занимает младшие 16 бит из регистра EAX.

В процессорах с разрядностью 64 бита (x86-64 архитектура) были введены 64-битные регистры (например, RAX), в которых регистры EAX занимают младшие 32 бита.
